...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        autoChooser.addObject("Pickup Gray Totes", new PickupGrayTotes());
        autoChooser.addObject("Pickup 2 yellow totes", new PickupYellowTotes());
        autoChooser.addObject("Pickup 1 yellow tote", new PickupYellowTote());
