...
public class RobotMap {
    ...
    public static DigitalInput elevatorelevatorHeightLimit;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    
    public static Encoder wheelCount;
    ...
    public static void init() {
        ...
        elevatorelevatorHeightLimit = new DigitalInput(0);
        LiveWindow.addSensor("Elevator", "elevatorHeightLimit", elevatorelevatorHeightLimit);
        

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        
        wheelCount = new Encoder(6, 7, false, EncodingType.k4X);
    }
}
