...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("ElevatorCommand", new ElevatorCommand());

        SmartDashboard.putData("ArmCommand", new ArmCommand());

        SmartDashboard.putData("DriveForwardRangeFinder", new DriveForwardRangeFinder());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        Button elevatorDown = new JoystickButton(functionJoystick, 3);
        Button elevatorUp = new JoystickButton(functionJoystick, 4);
